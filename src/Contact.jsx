                ...
                <div className="form">
                    <div className="contact-info">
                        ...
                        <div className="contact-box">
                            ...
                            <p className="text">We are Computer Science Engineering and Information Technology Students in MAKAUT,W.B. We opened a community together. So, we basically work on the website development. We aslo work as a freelancer.</p>
                            <div className="info">
